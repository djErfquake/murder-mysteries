<script>
    import EnterCode from '../screens/EnterCodeScreen.svelte';
    import Character from '../screens/CharacterScreen.svelte';

    let character = null;

    const gotCharacter = e => {
        character = e.detail;
        console.log("index gotCharacter", character);
    }
...
<div>
    ...
    {:else}
    <EnterCode on:gotCharacter={gotCharacter} />
    {/if}
</div>
